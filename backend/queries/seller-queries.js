...
const getSellerById = "SELECT u.store_name AS store_name, u.address as address, sc.name AS store_category FROM users u JOIN seller_categories sc ON u.seller_category_id = sc.id where u.id = $1"
