...
const getReviwsById = "select us.name as user_name, r.rating, r.comment from reviews r join users u on r.user_seller_id = u.id join users us on r.users_id = us.id where u.id = $1"
